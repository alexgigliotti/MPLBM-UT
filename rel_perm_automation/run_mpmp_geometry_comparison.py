...
class AutomatedMPMP():
    ...
    def __init__(self):
        ...
        self.output_directory = 'geometry_comparison_test'
    ...
    def create_output_directory(self, i):
        ...
        os.system("mkdir ../" + output_dir + "/" + geom_names[i])
    ...
    def download_geometry_file(self, i):
        ...
        os.system("wget -O tmp/raw_geometry/" + geom_names[i] + ".raw " + geom_links[i])
    ...
    def update_and_run_geometry_creation_matlab_file(self, i):
        ...
        replacement_line = "raw_geometry_file_to_open = 'tmp/raw_geometry/" + geom_names[i] + ".raw';"
    ...
    def run_shan_chen_lbm_simulation(self):
        ...
        os.system('mv capillary_number_data.csv capillary_pressure_data.csv mobility_ratio_data.csv '\
                  'run_data.csv runnum.dat tmp/2_phase_shanchen_output/numerical_outputs')
        os.system('mv tmp/2_phase_shanchen_output/rho_f1_*.gif tmp/2_phase_shanchen_output/gifs/')
        os.system('mv tmp/2_phase_shanchen_output/rho_f1_*.vti tmp/2_phase_shanchen_output/fluid_geometry_files/')
    ...
    def update_rel_perm_input_file(self, i):
        ...
        number_of_runs = np.loadtxt('tmp/2_phase_shanchen_output/numerical_outputs/runnum.dat')
        ...
        os.system("cp input/*.dat tmp/rel_perm_calculation/fluid_geometry_input/input")
    ...
    def create_geometry_for_rel_perms(self):
        ...
        add_path = "addpath('/workspace/gigliotti/MultiphasePorousMediaPalabos/post-processing');"
        os.system('matlab -r "' + add_path +' read_save_fluids; exit"')

        # Organize output
        os.system('mv tmp/2_phase_shanchen_output/fluid_geometry_files/*.csv tmp/2_phase_shanchen_output/fluid_geometry_files/Sw.csv')
        os.system('mv lattice_f* tmp/rel_perm_calculation/fluid_geometry_input/')
        os.system('mv tmp/2_phase_shanchen_output/fluid_geometry_files/Sw.csv tmp/2_phase_shanchen_output/numerical_outputs/')
    ...
    def run_rel_perm_simulation(self):
        ...
        os.system('mv perm_data.csv relperm_data.csv tmp/rel_perm_calculation/numerical_outputs/')
    ...
    def save_results_and_clear_temp(self, i):
        ...
        os.system("cp -a tmp/. ../" + output_dir + "/" + geom_names[i] + "/")

        # Delete temporary files and geometry input file in automation directory
        os.system("find tmp/ -type f -delete")
